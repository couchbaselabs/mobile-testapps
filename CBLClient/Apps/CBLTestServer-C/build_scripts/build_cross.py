...
if __name__ == '__main__':
    ...
    # new
    base_zip_filename = f"couchbase-lite-vector-search-{args.vs_version}"
    ...
    urllib.request.urlretrieve(f'{base_download_url}/{base_zip_filename}-linux-x86_64.zip', vector_search_zip_name, show_download_progress)
