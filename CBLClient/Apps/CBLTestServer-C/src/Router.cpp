...
static const unordered_map<string, endpoint_handler> ROUTE_MAP = {
    ...
    {"array_setString", array_methods::array_setString},
    {"blob_create", blob_methods::blob_create},
    {"blob_createUTFBytesContent", blob_methods::blob_createUTFBytesContent},
    ...
    {"collection_getDocuments", collection_methods::collection_getDocuments},
    ...
    {"collection_saveDocuments", collection_methods::collection_saveDocuments},
    {"collection_getDocIds", collection_methods::collection_getDocIds},
